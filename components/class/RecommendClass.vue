            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-list-item class="grow">
                  <v-list-item-avatar color="grey darken-3">
                    <v-img class="elevation-6" src="https://img.icons8.com/plasticine/2x/user.png"></v-img>
                  </v-list-item-avatar>

                  <v-list-item-content>
                    <v-list-item-title>Name Tutor</v-list-item-title>
                  </v-list-item-content>
              ...
              <div v-show="card.show">
                ...
                <v-card-text>
                  ...
                  Aliquam at auctor augue. Nunc porta, magna eu porta bibendum,
                  diam est sollicitudin ipsum, eget ultrices risus lacus
                  a tellus.
                </v-card-text>
              </div>
            </v-card>
              ...
              <v-card>
                ...
                <v-card-actions>
                  ...
                  <v-list-item class="grow">
                    ...
                    <v-list-item-content>
                      <v-list-item-title>Name User</v-list-item-title>
                    </v-list-item-content>
  ...
  data() {
    return {
      ...
      cards: [
        ...
        {
          title: "PHP from zero to hero",
          src: "https://www.petanikode.com/img/php/php.png",
          flex: 4,
          show: true
        },
        {
          title: "React in 1 day",
      ...
      cards2: [
        ...
        },
        {
          title: "C++ in 1 day",
          src:
            "https://d33wubrfki0l68.cloudfront.net/49aee5fa96e490bb03748d978eef21f0b479b14f/c32d1/img/cpp.png",
          flex: 4,
          show: true
        }
      ]
